...
import { Text,View,ImageBackground,SafeAreaView,StatusBar,StyleSheet,Alert,Image, } from "react-native";
  ...
  this.getIssLocation();
    ...
    render(){
        ...
        return(
            ...
            <ImageBackground source ={require("../assets/espaco2.jpg")}
                        style = {styles.espaco}>
   ...
   <Marker coordinate={{
    ...
    <Image source = {require("../assets/EEI.png")}
      style = {styles.icone}    />
